  ...
  return (
    <div className="pt-2.5 2xl:pt-4 border-t border-primary/10 flex items-center justify-between flex-wrap gap-2">
      ...
      <div className="flex items-center gap-1 sm:gap-2 font-mono">
        <div className={cn("flex items-center gap-1 bg-[#16130d] border border-warning/30",
          "px-2 py-0.5 2xl:px-3 2xl:py-1 rounded-md text-warning font-bold text-xs sm:text-sm 2xl:text-base shadow-inner")}>
