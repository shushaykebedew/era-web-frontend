...
export function GalleryHero() {
  return (
    <section className="bg-background pb-10 pt-28 text-center sm:pt-36 lg:pt-40">
      <Container size="narrow">
        ...
        <p className="mx-auto mt-6 mb-10 sm:mb-16 lg:mb-20 max-w-[620px] text-base sm:text-[18px] leading-7 text-foreground-muted font-inter">
