...
export default function CategoriesPage() {
  return (
    <>
      ...
      <section className="bg-background py-16 sm:py-24 border-t border-[#EBC16633] w-full">
        <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16">
          <div className="flex flex-col gap-12 lg:gap-0 overflow-hidden lg:flex-row lg:justify-between">
            {/* Left — text */}
            <div className="flex flex-col justify-center w-full lg:w-1/2 max-w-full lg:max-w-md min-w-0">
