    ...
    <>
      ...
      <section className="bg-background pb-16 pt-40 text-center">
        <Container size="wide">
          ...
          <h1 className="mx-auto font-display text-3xl sm:text-4xl lg:text-[48px] xl:text-[72px] font-bold leading-tight lg:leading-13 xl:leading-20 tracking-tight lg:tracking-[-1.44px] text-[#EAE1D7] max-w-[728px]">
